...
module Players
  class Computer < Player
    ...
    def move(board)
      ...
      elsif check_win_combos == nil && board.turn_count == 3 && board.taken?(1) && board.position(1) == board.position(9) || board.turn_count == 3 && board.taken?(3) && board.position(3) == board.position(7)
        move = "2"
